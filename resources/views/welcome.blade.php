<x-layout>
    <x-slot:title>Sewa Kamera & Alat Sinematografi | Lumen-K</x-slot:title>

    <div class="container mt-4 mb-5">
        <!-- Hero Banner -->
        <div class="p-5 mb-5 bg-dark text-white rounded-4 shadow-sm position-relative overflow-hidden">
            <div class="py-4 text-center">
                <h1 class="display-4 fw-bold mb-3">Sewa Kamera & Alat Sinematografi</h1>
                <p class="lead text-white-50 mx-auto mb-4" style="max-width: 700px;">
                    Pilihan lengkap kamera mirrorless, lensa premium, lighting, audio, hingga drone untuk mendukung produksi visual profesionalmu di Bandung & Subang.
                </p>
                <a href="{{ route('catalog.index') }}" class="btn btn-warning btn-lg fw-bold px-4 mt-3 shadow">
                    <i class="bi bi-grid-fill me-2"></i>Jelajahi Semua Katalog
                </a>
            </div>
        </div>
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h3 class="fw-bold mb-0 text-dark"><i class="bi bi-fire text-danger me-2"></i>Paling Banyak Disewa</h3>
                    ...
                    <div class="card h-100 shadow-sm border-0 card-hover">
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <span class="badge bg-success-subtle text-success mb-3 align-self-start">
                                Tersedia: {{ $item->stock_quantity }} Unit
                            </span>

                            <p class="card-text text-muted small flex-grow-1">
                                {{ Str::limit($item->description ?? 'Tidak ada deskripsi spesifikasi.', 80) }}
                            </p>
